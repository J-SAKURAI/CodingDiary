...
/**
 * PreFormulaMaterials entity. @author MyEclipse Persistence Tools
 */

public class PreFormulaMaterials implements java.io.Serializable {
	...
	/** default constructor */
	public PreFormulaMaterials() {
	}

	/** minimal constructor */
	public PreFormulaMaterials(Timestamp updTm, String updUsr) {
		this.updTm = updTm;
		this.updUsr = updUsr;
	}

	/** full constructor */
	public PreFormulaMaterials(PreFormulas preFormulas,
			Units unitsByConfigQuantityUnitId, Materials materials,
	...
	public PreFormulas getPreFormulas() {
		return this.preFormulas;
	}

	public void setPreFormulas(PreFormulas preFormulas) {
		this.preFormulas = preFormulas;
	}
