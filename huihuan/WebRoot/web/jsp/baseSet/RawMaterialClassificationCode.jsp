...
<div class="row breadcrumb-row">
	<ol class="breadcrumb">
		...
		<li class="active">原辅料分类编码</li>
	</ol>
</div>

<div class="row wrapper">
	<div class="set-row">
		<label for="">原辅料分类：</label> <select name="" id="catagorisSelect"
			class="form-control" onchange="selectCatagory(this.value)">
		</select>
	</div>
</div>
...
<div class="row wrapper sortcode-row">
	<div class="row sortcode-info-row">
		<label>编码的第<span id="catagoryBit"></span>位：</label><label
			id="catagoryExample"><span class="choose-red"></span>
		</label> <a class="btn-add" onclick="addCatagoryDetail()"><img src="../image/add.png" alt="增加" class="btn-img">
		</a>
	</div>
	<div class="row table-row">
		<table class="table sort-table table-striped" id="catagoryTable">
			<thead>
				<tr>
					<th>序号</th>
					<th>分类编码</th>
				...
				<tr id="selectTemplete" style="display:none">
					<input id="type" type="hidden" sourceId="catagoryTypes"
						sourceType="select" />
					<td><span id="index"></span>
					</td>
					<td><input id="code" type="text" value="" class="form-control"
