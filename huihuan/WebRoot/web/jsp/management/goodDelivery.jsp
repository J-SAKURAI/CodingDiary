...
function search(){
	...
	var aoColumns = [ 
		...
		var ajaxSource = {
			"select" : "${pageContext.request.contextPath}/activityOperationAction_getGoodDeliveryInfos",
			"get" : "${pageContext.request.contextPath}/activityOperationAction_getGoodDeliveryInfoDetail", 
			"edit" : "${pageContext.request.contextPath}/activityOperationAction_editGoodDeliveryInfo",
		};
